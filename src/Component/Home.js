...
const Home = () => {
    ...
    <Card style={{ margin: 20, padding: 20,backgroundColor:"#bcf8cf" }}>
        ...
        <CardImg top width="100%" src="https://www.nationaljewish.org/getattachment/Clinical-Trials/New-Trial-Medication-for-Pulmonary-Arterial-Hypertension/Image-Small-WIRB20181163.jpg.aspx?lang=en-US" style={{  width: 405, height: 250}} />
            <CardBody>
